                ...
                @else
                    <form class="form-horizontal" method="POST" action="editcat" id="catFields">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                @if(empty($cat))
                                    <input type="text" name="cat_name" class="form-control1" id="focusedinput"
                                           placeholder="">
                                @else
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                @else
                                    <input type="text" class="form-control1" id="breed"
                                           value="{!! $cat['cat_breed'] !!}" name="cat_breed" placeholder="">
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                @if(empty($cat))
                                    <div class="radio-inline"><label><input type="radio" name="gender" value="male"
                                                                            checked>Male<br></label>
                                    </div>
                                    <div class="radio-inline"><label><input type="radio" name="gender"
                                                                            value="female">Female<br></label>
                                    </div>
                                @else
                                    @if($cat->gender=="male")
                                        <div class="radio-inline"><label><input type="radio" name="gender" value="male"
                                                                                checked="true">Male<br></label>
                                        </div>
                                        <div class="radio-inline"><label><input type="radio" name="gender"
                                                                                value="female">Female<br></label>
                                        </div>
                                    ...
                                    @if($cat->gender=="female")
                                        <div class="radio-inline"><label><input type="radio" name="gender"
                                                                                value="male">Male<br></label>
                                        </div>
                                        <div class="radio-inline"><label><input type="radio" name="gender"
                                                                                value="female" checked="true">Female<br></label>
                                        </div>
                                    @endif
                                @endif
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group" style="margin: 0px 0px 0px 15px">
                                ...
                                @if(empty($cat))
                                    <input class="form-control" id="catDob" name="dob" placeholder="MM/DD/YYYY"
                                ...
                                @else
                                    @if($cat->dob == null)
                                        <input class="form-control" id="catDob" name="dob" placeholder="MM/DD/YYYY"
                                               type="text" style="width: 120px;"/>
                                    @else
                                        <input class="form-control" id="catDob" name="dob" value="{!! $cat['dob'] !!}"
                                               placeholder="MM/DD/YYYY" type="text" style="width: 120px;"/>
                                    @endif
                                @endif
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                @if(empty($cat))
                                    <input type="number" name="current_weight" step="any" min="0" max="100"
                                           class="form-control1 input-sm"
                                           id="currentWeight" placeholder="">
                                @else
                                    <input type="number" name="current_weight" value="{!! $cat['current_weight'] !!}"
                                           step="any" min="0" max="100" class="form-control1 input-sm"
                                           id="currentWeight" placeholder="">
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                @if(empty($cat))
                                    <input type="number" name="target_weight" step="any" min="0" max="100"
                                           class="form-control1 input-sm"
                                           id="targetWeight" placeholder="">
                                @else
                                    <input type="number" name="target_weight" value="{!! $cat['target_weight'] !!}"
                                           step="any" min="0" max="100" class="form-control1 input-sm"
                                           id="targetWeight" placeholder="">
                                @endif
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                @if(empty($cat))
                                    <input type="number" name="daily_calories" step="any" min="0" max="1000"
                                           class="form-control1 input-sm"
                                           id="dailyCallories" placeholder="">
                                @else
                                    <input type="number" name="daily_calories" value="{!! $cat['daily_calories'] !!}"
                                           step="any" min="0" max="1000" class="form-control1 input-sm"
                                           id="dailyCallories" placeholder="">
                                @endif
                            </div>
                        </div>
