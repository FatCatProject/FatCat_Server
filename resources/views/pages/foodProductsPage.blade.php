        ...
        <div class="graphs" id="Edit">
            ...
            <div class="row">
                ...
                <div id="addProductBlock" class="col-sm-6">
                    ...
                    <div class="tab-content" style="padding:0px">
                        <div class="tab-pane active" id="horizontal-form">
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="addFood"
                                  id="addFoodForm">
                                {!! csrf_field() !!}
                                <div class="col-sm-12">
                                    {{--Product name--}}
                                    <div class="form-group">
                                        <label for="food_name_add_input" class="col-sm-3 control-label">Name: <span
                                                style="color: red;">*</span></label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control1" name="food_name"
                                                   id="food_name_add_input"
                                    ...
                                    <div class="form-group">
                                        <label for="foodWeight"
                                               class="col-sm-3 control-label label-input-sm">Weight: <span
                                                style="color: red;">*</span></label>
                                        <div class="col-sm-8">
                                            <input type="number" name="weight_left" step="any" min="0" max="100000"
                                                   class="form-control1 input-sm" id="currentWeight"
                                                   placeholder="Enter weight in Grams" required>
                                        </div>
                ...
                <div hidden id="editProductBlock" class="col-sm-6">
                    ...
                    <div class="tab-content" style="padding:0px">
                        <div class="tab-pane active" id="horizontal-form">
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="editFood"
                                  id="editFoodForm">
                                {!! csrf_field() !!}
                                ...
                                <div class="form-group">
                                    <div class="col-sm-5" style="margin:20px 0 0 15px">
                                        ...
                                        <button id="cancelEditFoodProductBtn" type="button" class="btn-inverse btn">
                                            Cancel
                                        </button>
                                    </div>
                                </div>
                    ...
                    @php ($index = 0)
                        @for($row=0;$row<$numberOfRows;$row++)
                            @for(;$index<count($myFoods);$index++)
                                @if(!empty($myFoods))
                                    <div id="food_id_{!! $myFoods[$index]->id !!}" class="col-md-3 widget widget1"
                                         style="padding: 10px 0px">
                                        <div
                                            style="background-color: white; box-shadow: 0 1px 3px 0px rgba(0, 0, 0, 0.2);">
                                            <ul class="nav nav-pills">
                                                <li class="editFoodBtn"><a href="#Edit"><i
                                                            class="lnr lnr-pencil editValues" onclick=""></i></a></li>
                                        ...
                                        <div class="r3_counter_box">
                                            ...
                                            <div class="stats">
                                                ...
                                                <input type="hidden" id="foodName"
                                                       value="{!! $myFoods[$index]->food_name !!}">
                                                <div class="gramsNow row" style="margin:0px 0px 0 0">

                                                    <h5 id="weight_left_id{!! $myFoods[$index]->id !!}">
                                                        @if($myFoods[$index]->weight_left >0)
                                                            {!! $myFoods[$index]->weight_left !!}<span> grams left</span>
                                                        @else
                                                            {!! 0 !!}
                                                            <span> grams left</span>
                                                        @endif
                                                ...
                                                <div hidden class="row gramsToAdd" style="min-height:55px ;">
                                                    <div class="col-sm-6" style="padding: 0px;">
                                                        <input type="number" id="addFoodWeight" step="any" min="0"
                                                               max="10000"
                                                               class="form-control1" id="currentWeight" placeholder=""
                                                               required>
                                                    </div>
                                                    <div class="col-sm-2">
                                                        <p class="help-block">Grams</p>
                                                    ...
                                                    <div class="col-sm-4" style="padding: 0px;">
                                                        <ul class="nav nav-pills">
                                                            <li class="updateBtn"><a><i
                                                                        class="lnr lnr-checkmark-circle"></i></a></li>
                                                            <li class="cancelAdd"><a><i
                                                                        class="lnr lnr-cross-circle"></i></a></li>
                                                        </ul>
                                                    </div>
            ...
            $('.updateBtn').on("click", function () {
                ...
                $.ajax({
                    ...
                    success: function (data, textStatus, jqXHR) {
                        ...
                        if (newWeight > 0) {
                            $("#weight_left_id" + this.caller).html(newWeight.toFixed(2) + "<span>&nbsp;&nbsp; grams left</span>");
                        }
                        else {
                            $("#weight_left_id" + this.caller).html("0" + "<span>&nbsp;&nbsp; grams left</span>");
                        }
